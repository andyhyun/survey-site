    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <ul class = "navbar-nav mr-auto">
            ...
            <?php if (is_logged_in()): ?> <!-- If the user is logged in, show these options -->
                ...
                <li class="nav-item"><a class="nav-link text-light" href="<?php echo get_url("random_survey.php"); ?>">Random Survey</a></li>
        ...
        <?php if(is_logged_in()): ?>
            <span class="navbar-text text-light"><?php safer_echo(get_username()); ?></span>
        <?php endif; ?>
    <nav>
</div>