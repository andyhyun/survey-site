    ...
    <form method="POST">
        ...
        <div class="list-group">
            <div class="list-group-item">
                ...
                <button class="btn btn-secondary" style="margin-left: 20px;margin-bottom: 16px;margin-top: 30px;" onclick="event.preventDefault(); cloneThis(this);">Add Answer</button>
            </div>
        </div>
